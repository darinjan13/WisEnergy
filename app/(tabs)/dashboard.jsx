...
import { View, Text, ScrollView, StyleSheet, TouchableOpacity, ActivityIndicator, Modal, TouchableWithoutFeedback, Pressable } from 'react-native';
...
export default function Dashboard() {
    ...
    return (
        ...
        <GestureHandlerRootView>
            <Pressable onPress={toolTip ? () => {
                setToolTip(false); console.log("ASD");
            } : undefined}>
                {/* <View> */}
                        ...
                        <>
                            <View className="p-6 mb-6 items-center relative">
                                <PieChart
                                    ...
                                    textColor="black"
                                />
                                <Tooltip toolTip={toolTip} setToolTip={setToolTip} content={`Energy Efficiency Index is calculated from your consumption patterns compared to your budget and previous usage. \n A higher score means more efficient energy use.`} from="Dashboard" />
                            </View>
