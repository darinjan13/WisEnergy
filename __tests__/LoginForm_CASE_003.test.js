...
describe("Test Case ID: CASE-003", () => {
  test(
    [
      "Test Case Description: User leaves password field empty | Expected Result: Login fails with 'Password is required' error message",
      "Actual Result: System displayed 'Password is required' error message | Outcome: PASSED",
    ].join("\n"),
    async () => {
      render(<LoginForm />);
